...
<table class="table table-striped table-hover table-vcenter  fs-sm">
    ...
    @foreach($contents as $content)
        ...
        <tr>
            ...
            <td>{{$content->subtitle ? $content->subtitle : 'No subtitle'}}</td>
                                   ...
                                   'files'=>false])
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input type="hidden" name="parent_id" value="{{ $parent_id }}">
                                            <div class="mb-4">
                                                <label class="form-label" for="frontend-contact-firstname">Subtitle</label>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-4">
                                                ...
                                                <textarea type="text" id="editor" class="form-control" name="text"
