            ...
            <div class="col-lg-10 offset-lg-1">
                ...
                @if($buttons)
                    @foreach($buttons as $button)
                        <div class="mt-4" wire:key="button_{{ $button->id }}">
                            ...
                            <input wire:model="multiple_button_name.{{ $button->id }}" type="text" class="form-control" placeholder="{{ $button->name }}">

                            <label for="">Button link:</label>
                            <input wire:model="multiple_button_link.{{ $button->id }}" class="form-control" type="text" placeholder="{{ $button->link }}">
