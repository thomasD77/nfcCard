    ...
    <div class="container gutter-top">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header pt-1">
                                        <div class="d-flex flex-column">
                                            ...
                                            <p>Please fill in your information. I will send you a mail to talk
                                                later.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea name="message" placeholder="Enter your message... "
                                                      class="form-control input_modal" id="" cols="5"
                                                      rows="5"></textarea>
                                        ...
                                        <small class="mb-3 pl-2">*I agree to the terms and conditions by clicking
                                            send</small>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 offset-md-2">
                ...
                <!-- Footer -->
                <footer class="footer"><a style="text-decoration: none; color: white"
                                          href="https://innova-webcreations.be">SWAP</a> © {{ now()->format('Y') }}
                </footer>
                <footer class="footer">
                    <a style="text-decoration: none; color: black" class="badge badge-pill bg-white px-3 py-2"
