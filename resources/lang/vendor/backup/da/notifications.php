...
return [
    ...
    'backup_failed_body' => 'Vigtigt: Der skete nl fejl under backup af :application_name',

    'backup_successful_subject' => 'Ny backup af :application_name oprettet',
    'backup_successful_subject_title' => 'Ny backup!',
    'backup_successful_body' => 'Gode nyheder - der blev oprettet nl ny backup af :application_name på disken :disk_name.',

    'cleanup_failed_subject' => 'Oprydning af backups for :application_name fejlede.',
    'cleanup_failed_body' => 'Der skete nl fejl under oprydning af backups for :application_name',
    ...
    'unhealthy_backup_found_unknown' => 'Beklager, nl præcis årsag kunne ikke findes.',
