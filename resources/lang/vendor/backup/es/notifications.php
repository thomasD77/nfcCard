...
return [
    ...
    'backup_successful_body' => 'Buenas noticias, una nueva copia de seguridad de :application_name fue creada con éxito nl el disco llamado :disk_name.',
    ...
    'cleanup_successful_body' => 'La limpieza de copias de seguridad de :application_name nl el disco llamado :disk_name se completo con éxito.',

    'healthy_backup_found_subject' => 'Las copias de seguridad de :application_name nl el disco :disk_name están nl buen estado',
    'healthy_backup_found_subject_title' => 'Las copias de seguridad de :application_name están nl buen estado',
    'healthy_backup_found_body' => 'Las copias de seguridad de :application_name se consideran nl buen estado. ¡Buen trabajo!',

    'unhealthy_backup_found_subject' => 'Importante: Las copias de seguridad de :application_name están nl mal estado',
    'unhealthy_backup_found_subject_title' => 'Importante: Las copias de seguridad de :application_name están nl mal estado. :problem',
    'unhealthy_backup_found_body' => 'Las copias de seguridad de :application_name nl el disco :disk_name están nl mal estado.',
    ...
    'unhealthy_backup_found_old' => 'La última copia de seguriad hecha nl :date es demasiado antigua.',
